...
import {AuditClient, IAuditClientDispatcher, IAuditClientCryptoProvider} from "./audit_client";
import {TestAuditClientCryptoProvider} from "./tmp_crypto_stuff";
import {SecurityContext, SourceAuditEntry} from "@mojaloop/auditing-bc-public-types-lib";
import {KafkaAuditClientDispatcher} from "./kafka_audit_dispatcher";
...
async function start() {
    const cryptoProvider: IAuditClientCryptoProvider = new TestAuditClientCryptoProvider("../../test_keys/3_private.pem");
